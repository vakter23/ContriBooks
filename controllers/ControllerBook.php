...
class ControllerBook
{
    ...
    public function __construct($url)
    {
        if (isset($url) && count(array($url)) > 1)
            ...
            $this->_view->generate(array('book' => $book, 'commentaires' => $allComments, 'userComments' => $userComments, 'authors' => $authors, 'wishes' => $wishlist, 'allbooks' => $allBooks,'likelist' => $likelist));
        }
