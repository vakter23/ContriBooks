    ...
    <div class="row">
        <div class="">
            <div class="d-flex flex-column">
                ...
                ?>
                <div class="p-2 nav-item book-list" genre="<?= $book->getId_genre() ?>"
                     type="<?= $book->getId_type() ?>" author="<?= $book->getId_author() ?>"
                ">
                <div class="row border border-primary" style="background-color: #B9C6CE">
                    <div class="col border-right border-primary">
                        <p class="border border-primary "
                           style="font-size: 55px; margin-top: 55px;padding: 10px;padding-left: 60px; "><?= $i ?></p>
                    </div>
                    ...
                    <div class="col-6">
                        <a class="font-weight-bold" style="font-size: 25px;"
                           href="/Contribooks/Book?ISBN=<?= $ISBN ?>"><?= $book->getTitle_book() ?></a>
                        <p style="font-size: 17px;">
                            <?= mb_strimwidth($book->getSynopsis_book(), 0, 420, " ..."); ?>
                        </p>
                    </div>
                    <div class="col text-center ">
                        <p class="border border-primary rounded-circle"
                           style="font-size: 55px; margin-top: 55px;padding: 10px;"><?= $book->getRate() ?></p>
                    </div>
                </div>
